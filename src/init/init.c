...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/26 15:49:30 by rasamad           #+#    #+#             */
/*   Updated: 2024/06/26 18:17:23 by rasamad          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	assign_new_philosopher_data(t_simulation_state *simulation_context,
				t_philosopher *philosopher, char **argv)
{
	philosopher->sim_data.philo_count = ft_atoi(argv[0]);
	philosopher->sim_data.time_to_die = ft_atoi(argv[1]);
	philosopher->sim_data.time_to_eat = ft_atoi(argv[2]);
	philosopher->sim_data.time_to_sleep = ft_atoi(argv[3]);
	if (argv[4])
		philosopher->sim_data.required_eat_times = ft_atoi(argv[4]);
